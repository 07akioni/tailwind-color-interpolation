...
const indexes = [
  50, 75, 100, 125, 150, 200, 250, 300, 350, 400, 450, 500, 550, 600, 650, 700, 750,
  800, 850, 900, 950,
];

const detail = {
  "--ds-rgb-slate-50": "248 250 252",
  "--ds-rgb-slate-75": "245 248 251",
  "--ds-rgb-slate-100": "241 245 249",
  "--ds-rgb-slate-125": "237 241 246",
  ...
  "--ds-rgb-gray-75": "246 247 249",
  "--ds-rgb-gray-100": "243 244 246",
  "--ds-rgb-gray-125": "239 240 243",
  ...
  "--ds-rgb-zinc-75": "247 247 248",
  "--ds-rgb-zinc-100": "244 244 245",
  "--ds-rgb-zinc-125": "240 240 241",
  ...
  "--ds-rgb-neutral-75": "248 248 248",
  "--ds-rgb-neutral-100": "245 245 245",
  "--ds-rgb-neutral-125": "241 241 241",
  ...
  "--ds-rgb-stone-75": "248 248 247",
  "--ds-rgb-stone-100": "245 245 244",
  "--ds-rgb-stone-125": "241 241 240",
  ...
  "--ds-rgb-red-75": "254 234 234",
  "--ds-rgb-red-100": "254 226 226",
  "--ds-rgb-red-125": "254 220 220",
  ...
  "--ds-rgb-orange-75": "255 242 225",
  "--ds-rgb-orange-100": "255 237 213",
  "--ds-rgb-orange-125": "254 231 202",
  ...
  "--ds-rgb-amber-75": "255 247 217",
  "--ds-rgb-amber-100": "254 243 199",
  "--ds-rgb-amber-125": "253 239 183",
  ...
  "--ds-rgb-yellow-75": "254 251 214",
  "--ds-rgb-yellow-100": "254 249 195",
  "--ds-rgb-yellow-125": "254 246 180",
  ...
  "--ds-rgb-lime-75": "242 253 217",
  "--ds-rgb-lime-100": "236 252 203",
  "--ds-rgb-lime-125": "231 251 191",
  ...
  "--ds-rgb-green-75": "230 253 238",
  "--ds-rgb-green-100": "220 252 231",
  "--ds-rgb-green-125": "211 250 225",
  ...
  "--ds-rgb-emerald-75": "223 252 237",
  "--ds-rgb-emerald-100": "209 250 229",
  "--ds-rgb-emerald-125": "198 248 223",
  ...
  "--ds-rgb-teal-75": "222 252 246",
  "--ds-rgb-teal-100": "204 251 241",
  "--ds-rgb-teal-125": "191 249 237",
  ...
  "--ds-rgb-cyan-75": "222 252 255",
  "--ds-rgb-cyan-100": "207 250 254",
  "--ds-rgb-cyan-125": "196 248 253",
  ...
  "--ds-rgb-sky-75": "232 246 255",
  "--ds-rgb-sky-100": "224 242 254",
  "--ds-rgb-sky-125": "214 239 253",
  ...
  "--ds-rgb-blue-75": "229 240 255",
  "--ds-rgb-blue-100": "219 234 254",
  "--ds-rgb-blue-125": "212 230 254",
  ...
  "--ds-rgb-indigo-75": "231 237 255",
  "--ds-rgb-indigo-100": "224 231 255",
  "--ds-rgb-indigo-125": "217 225 254",
  ...
  "--ds-rgb-violet-75": "241 238 255",
  "--ds-rgb-violet-100": "237 233 254",
  "--ds-rgb-violet-125": "233 228 254",
  ...
  "--ds-rgb-purple-75": "247 239 255",
  "--ds-rgb-purple-100": "243 232 255",
  "--ds-rgb-purple-125": "240 227 255",
  ...
  "--ds-rgb-pink-75": "253 237 246",
  "--ds-rgb-pink-100": "252 231 243",
  "--ds-rgb-pink-125": "251 225 240",
  ...
  "--ds-rgb-rose-75": "255 235 236",
  "--ds-rgb-rose-100": "255 228 230",
  "--ds-rgb-rose-125": "254 222 225",
...
for (const color of colors) {
  console.log(`struct ${color} {`);
  for (const index of indexes) {
    const key = `--ds-rgb-${color}-${index}`;
    const value = detail[key];
    const [r, g, b] = value.split(" ");
    console.log(
      `  static let i${index}: Color = .init(red: ${r}.0 / 255.0, green: ${g}.0 / 255.0, blue: ${b}.0 / 255.0)`
    );
  }
  console.log(`}`);
}
